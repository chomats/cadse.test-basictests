...
public class Test1_Long_tc_execution extends GTCadseTestCase {
	 ...
	 *        the instance number.
	 */
	public Test1_Long_tc_execution(int i) {
		instanceNumber = i;
	}
	...
	protected static GTCommonTestDriver getDriver() {
		return new Test1_Long_testDriver();
	}
	...
	protected static GTCommonParameters getParameters() {
		return new Test1_Long_parameters();
	}
}
