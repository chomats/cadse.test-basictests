...
public class Test1_Long_testDriver extends Test1_Common_testDriver {
	...
	protected void initializeTestParameters() {
		...
		KeyValue defValKv = new KeyValue(CadseGCST.ATTRIBUTE_at_DEFAULT_VALUE_, 10l);
		KeyValue newValue1Kv = new KeyValue(getAttributeName(), 11l);
		KeyValue newValue2Kv = new KeyValue(getAttributeName(), 12l);
		KeyValue newValue3Kv = new KeyValue(getAttributeName(), 13l);
