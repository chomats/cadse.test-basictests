...
/**
 * Tests basic properties for long attributes. CADSEg part.
 * <ul>
 * <li>default value</li>
...
public class BasicProperties_Long_tc_CADSEg extends GTCadseTestCase {
	 ...
	 *            the instance number.
	 */
	public BasicProperties_Long_tc_CADSEg(int i) {
		instanceNumber = i;
	}
