...
/**
 * Tests basic properties for string attributes. Execution part.
 * <ul>
 * <li>default value</li>
...
public class BasicProperties_String_tc_execution extends GTCadseTestCase {
	 ...
	 *            the instance number.
	 */
	public BasicProperties_String_tc_execution(int i) {
		instanceNumber = i;
	}
	...
	protected static GTCommonParameters getParameters() {
		return new BasicProperties_String_parameters();
	}
}
