...
public class Test1_Boolean_tc_execution extends GTCadseTestCase {
	 ...
	 *        the instance number.
	 */
	public Test1_Boolean_tc_execution(int i) {
		instanceNumber = i;
	}
	...
	protected static GTCommonTestDriver getDriver() {
		return new Test1_Boolean_testDriver();
	}
	...
	protected static GTCommonParameters getParameters() {
		return new Test1_Boolean_parameters();
	}
}
