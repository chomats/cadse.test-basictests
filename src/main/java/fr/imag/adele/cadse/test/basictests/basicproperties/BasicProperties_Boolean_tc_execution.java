...
/**
 * Tests basic properties for boolean attributes. Execution part.
 * <ul>
 * <li>default value</li>
...
public class BasicProperties_Boolean_tc_execution extends GTCadseTestCase {
	 ...
	 *            the instance number.
	 */
	public BasicProperties_Boolean_tc_execution(int i) {
		instanceNumber = i;
	}
	...
	protected static GTCommonParameters getParameters() {
		return new BasicProperties_Boolean_parameters();
	}
}
