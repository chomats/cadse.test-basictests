...
public class Test2_Double_parameters extends Test2_Common_parameters {

	/** Constructor */
	public Test2_Double_parameters() {
	...
	protected GTCollectionTestParameter initCTP() {
		...
		KeyValue kv12 = new KeyValue(CadseGCST.ATTRIBUTE_at_DEFAULT_VALUE_, new Double(123));
